...
=head1 SYNOPSIS
   ...
   plugin 'Bot::ChatBots::Messenger',
      ...
      instances => [
         WebHook => [
            path => '/messenger/yadda-yadda-yadda',
            processor => \&process,
...
This module inherits from L<Bot::ChatBots::WebHook>. The following
accessors are added:
...
This module inherits from L<Bot::ChatBots::WebHook> and implements or
